    ...
    return (
        <div className='px-3 md:px-10 mb-10 mt-5 sm:mt-8 flex flex-col md:flex-row w-full justify-center sm:flex sm:justify-center lg:justify-center'>
            <div className='flex flex-col items-center md:w-3/4'>
                ...
                <p className='text-lg mt-5 font-medium text-left w-full'>Whenever possible, I also apply my passion for developing products with    <span className='text-second italic'>Node.js</span>     and     <span className='text-second italic'>Modern Javascript Library and Frameworks</span>     like    <span className='text-second italic'>React.js.</span></p>
            </div>
