    ...
    <div className="relative inline-block text-center">
      ...
      {isPopoverVisible && (
        ...
        >
          ...
          <div className="px-3 text-sm  py-2 text-white font-medium">
            <span>{title}</span>
          </div>
          <div className="absolute bottom-[-6px] left-1/2 transform -translate-x-1/2 w-4 h-4 bg-second border-b border-r border-second rotate-45"></div>
        </div>
      )}
    </div>
  );
