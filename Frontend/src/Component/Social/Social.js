            ...
            <div className='w-full md:w-1/2 flex flex-col md:items-start md:justify-start items-center justify-center mt-8 md:mt-0'>
                ...
                <div className='mt-6 flex flex-col w-full justify-center items-center md:justify-start md:items-start'>
                    <form className='flex flex-col w-full justify-center items-center md:justify-start md:items-start' onSubmit={handleSubmit}>
                        ...
                        <input className='md:w-3/4 w-10/12 py-2 mt-4 font-lg px-4 bg-gray-100 outline-0 rounded' value={form.email} name='email' onChange={handleChange} required type='email' placeholder='Your Email Address' />
                        <input className='md:w-3/4 w-10/12 py-2 mt-4 font-lg px-4 bg-gray-100 outline-0 rounded' value={form.subject} name='subject' onChange={handleChange} required type='text' placeholder='Subject' />
                        <textarea className='md:w-3/4 w-10/12 py-2 mt-4 font-lg px-4 bg-gray-100 outline-0 rounded overscroll-none' value={form.message} name='message' onChange={handleChange} required cols="90" rows="5" placeholder="Leave a comment..." ></textarea>
